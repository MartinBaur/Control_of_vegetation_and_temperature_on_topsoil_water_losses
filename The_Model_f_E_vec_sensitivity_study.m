function [Ts, TC, ms, mD, Tra_s_vec, Tra_r_vec,Es_vec, Cap_flux_vec, f_E] = The_Model_f_E_vec_sensitivity_study(F, T_R, q_R, P,NDVI,root_frac,g_s_in,g_C_in,f_E_max,steps_per_day)
    ...
    %%% TUNABLE PARAMETERS (or ones I'm not confident about) %%%
      ...
      % rho_leaf = 300;     % density of leaf canopy [kg/m^3]
        ...
        rho_leaf = 300;     % density of leaf canopy [kg/m^3]
                 ...
                 g_s = g_s_in;       % dry surface conductance [m/s] ORIGINAL
                 g_C = g_C_in;        % vegetation conductance from canopy [m/s]                
    ...
    r = root_frac;            % Root fraction in surface layer
